...
public class AvroDeviceConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AvroDeviceConfig(java.lang.CharSequence ipAddress, java.lang.Integer frequency, java.lang.Boolean enabled) {
   ...
   */
  public static com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder newBuilder() {
    return new com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder();
  }
   ...
   * @return A new AvroDeviceConfig RecordBuilder
   */
  public static com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder newBuilder(com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder other) {
    if (other == null) {
      return new com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder();
    } else {
      return new com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder(other);
    }
  }
   ...
   * @return A new AvroDeviceConfig RecordBuilder
   */
  public static com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder newBuilder(com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig other) {
    if (other == null) {
      return new com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder();
    } else {
      return new com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroDeviceConfig>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ipAddress)) {
        this.ipAddress = data().deepCopy(fields()[0].schema(), other.ipAddress);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder clearIpAddress() {
      ipAddress = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder setFrequency(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder clearFrequency() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder setEnabled(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.heptagon.thirema.dataprocessor.kafka.gateway.avro.AvroDeviceConfig.Builder clearEnabled() {
